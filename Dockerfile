...
FROM php:5.6-alpine as stage-5.6
...
FROM php:7.0-alpine as stage-7.0
...
FROM php:7.1-alpine as stage-7.1
FROM php:7.2-alpine as stage-7.2
FROM php:7.3-alpine as stage-7.3
FROM php:7.4-alpine as stage-7.4
FROM php:8.0-alpine as stage-8.0
FROM php:8.1-alpine as stage-8.1
FROM php:8.2-alpine as stage-8.2
